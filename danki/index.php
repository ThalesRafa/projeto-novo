<?php get_header();?>
			...
			<div class="w50 time-descricao">
				...
				<a target="_blank" href="ttps://autocuidadoshop.com.br">Ver demonstração</a>
			</div><!--w50-->
	...
	<section class="clientes-slider">
		...
		<div style="max-width: 700px;margin: 0 auto;overflow: hidden;" class="slider-container">
			<img src="<?php echo get_theme_root_uri();?>/Danki/images/amazon.png" />
			<img src="<?php echo get_theme_root_uri();?>/Danki/images/costco.png" />
			<img src="<?php echo get_theme_root_uri();?>/Danki/images/dominos.png" />
			<img src="<?php echo get_theme_root_uri();?>/Danki/images/uber.png" />
			<img src="<?php echo get_theme_root_uri();?>/Danki/images/walmart.png" />
			<img src="<?php echo get_theme_root_uri();?>/Danki/images/amazon.png" />
			<img src="<?php echo get_theme_root_uri();?>/Danki/images/costco.png" />
			<img src="<?php echo get_theme_root_uri();?>/Danki/images/dominos.png" />
			<img src="<?php echo get_theme_root_uri();?>/Danki/images/uber.png" />
		...
		<div class="center">
			...
			<div class="depoimentos-box">
				<div class="depoimento-single">
					...
					<p>Thales Rafael</p>
					<img src="<?php echo get_theme_root_uri();?>/Danki/images/thales.jpg" />
